...
import { deleteFromCloudinary, findAverageRatings, invalidateCache, uploadToCloudinary, } from "../utils/feature.js";
...
export const updateProduct = TryCatch(async (req, res, next) => {
    ...
    if (!product)
        return next(new ErrorHandler("Product Not Found", 404));
    if (!sellingPrice)
        return next(new ErrorHandler("Enter Selling Price", 404));
